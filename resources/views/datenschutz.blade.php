    ...
    <section class="container g-pt-100 g-pb-70">
        <div class="row align-items-center">
            <div>
                ...
                <p class="lead">&nbsp;</p>
                <p class="lead"><span style="font-size:16px;"><h4><strong>Information über die Erhebung personenbezogener Daten</strong></h4></span>
                ...
                <p class="lead">&nbsp;</p>
                <p class="lead"><span style="font-size:16px;"><h4><strong>Erhebung personenbezogener Daten bei Besuch unserer Website</strong></h4></span>
                ...
                <p class="lead">&nbsp;</p>
                <p class="lead"><span style="font-size:16px;"><h4><strong>Weitere Funktionen und Angebote unserer Website</strong></h4></span>
                ...
                <p class="lead">&nbsp;</p>
                <p class="lead"><span style="font-size:16px;"><h4><strong>Newsletter</strong></h4></span>
                ...
                <p class="lead">(3) Pflichtangabe für die Übersendung des Newsletters ist allein Ihre E-Mail-Adresse. Die Angabe weiterer, gesondert markierter Daten ist freiwillig und wird verwendet, um Sie persönlich ansprechen zu können. Nach Ihrer Bestätigung speichern wir Ihre E-Mail-Adresse zum Zweck der Zusendung des Newsletters. Rechtsgrundlage ist Art. <a href="https://beck-online.beck.de/?typ=reference&amp;y=100&amp;a=6&amp;g=EWG_DSGVO" data-extlink="" target="_blank" rel=" noopener noreferrer">6<span class="ext"><span class="element-invisible">(link is external)</span></span></a> Abs. <a href="https://beck-online.beck.de/?typ=reference&amp;y=100&amp;a=6&amp;g=EWG_DSGVO&amp;x=1" data-extlink="" target="_blank" rel=" noopener noreferrer">1<span class="ext"><span class="element-invisible">(link is external)</span></span></a> S. 1 lit. a DSGVO.</p>
                ...
                <p class="lead">- E-Mail-Adresse<br>
                    - IP-Adresse</p>
                <p class="lead">Weitere Informationen können Sie der Datenschutzerklärung von MailChimp entnehmen welche unter <a href="https://mailchimp.com/legal/privacy/" data-extlink="" target="_blank" rel=" noopener noreferrer">https://mailchimp.com/legal/privacy/<span class="ext"><span class="element-invisible">(link is external)</span></span></a> abrufbar ist.<br>
                    MailChimp bzw. das Mutterunternehmen The Rocket Science Group LLC ist im Rahmen des US-EU-Privacy-Shield-Abkommens zertifiziert und stellt hierdurch sicher, das europäische Datenschutzniveau einzuhalten. Der aktuelle Status der Zertifizierung kann unter dem folgenden Link überprüft werden:<a href="https://www.privacyshield.gov/participant?id=a2zt0000000TO6hAAG" data-extlink="" target="_blank" rel=" noopener noreferrer"> https://www.privacyshield.gov/participant?id=a2zt0000000TO6hAAG<span class="ext"><span class="element-invisible">(link is external)</span></span></a></p>
                <p class="lead">&nbsp;</p>
                <p class="lead"><span style="font-size:16px;"><h4><strong>Kinder</strong></h4></span>
