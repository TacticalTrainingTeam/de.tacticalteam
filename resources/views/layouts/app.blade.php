...
<head>
    ...
    <script>
        ...
        (function() {
            var u="https://analytics.tacticalteam.de/";
                    ...
                    <nav class="text-uppercase1">
                        <ul class="list-unstyled g-mt-minus-10 mb-0">
                            ...
                            <li class="g-pos-rel g-brd-bottom g-brd-white-opacity-0_1 g-py-10">
                                <h4 class="h6 g-pr-20 mb-0">
                                    <a class="g-color-white-opacity-0_8 g-color-white--hover"
                                       href="https://prae-garde.de/">Praetorianische Garde</a>
                                    <i class="fa fa-angle-right g-absolute-centered--y g-right-0"></i>
                                </h4>
                            </li>
                            <li class="g-pos-rel g-brd-bottom g-brd-white-opacity-0_1 g-py-10">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 text-center text-md-left g-mb-15 g-mb-0--md">
                    <div class="d-lg-flex">
                        <small class="d-block g-font-size-default g-mr-10 g-mb-10 g-mb-0--md">{{ date('Y') }} &copy; All Rights
                            Reserved.</small>
                ...
                <div class="col-md-4 align-self-center">
                    <ul class="list-inline text-center text-md-right mb-0">
                        ...
                        <li class="list-inline-item g-mx-10" data-toggle="tooltip" data-placement="top" title="X (Twitter)">
                            <a href="https://x.com/ttt_arma" class="g-color-white-opacity-0_5 g-color-white--hover">
